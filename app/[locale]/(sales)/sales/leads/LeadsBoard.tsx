  ...
  return (
    <div className="space-y-6">
      ...
      {canImport && importOpen ? <section className="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4" aria-label={t("importLeads")}>
        ...
        {importMessage ? <p className="text-sm font-medium text-primary" role="status">{importMessage}</p> : null}{errorMessage ? <p className="text-sm font-medium text-[#b42318]" role="alert">{errorMessage}</p> : null}
      </section> : null}

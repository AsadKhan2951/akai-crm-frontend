...
function recencyClass(value: string | null) {
  if (!value) return "bg-[#D6202C]";
  const days = Math.floor((Date.now() - new Date(value).getTime()) / 86_400_000);
  if (days <= 30) return "bg-[#16233F]";
  if (days <= 90) return "bg-[#64748B]";
  return "bg-[#D6202C]";
}
